// Courtesy of https://github.com/StevenBlack/hosts
...
var blocked_domains = [
  ...
  "*://*.dcs-tgt.apis.anvato.net/*",
  "*://*.dcs-vod.apis.anvato.net/*",
  "*://*.drm.apis.anvato.net/*",
  "*://*.tkx.apis.anvato.net/*",
  "*://*.cdn.anvato.net/*",
  "*://*.dcs-jite.cdn.anvato.net/*",
  "*://*.w3.cdn.anvato.net/*",
  "*://*.gcdn.anvato.net/*",
  "*://*.d2oj2jfp5qkm5dtc3gtiqjzaab.gcdn.anvato.net/*",
  "*://*.gpizacfw3gtfw4vmh5nc4uq6gc.gcdn.anvato.net/*",
  "*://*.jkvdxu3faz4qgr2j6w5qctdnde.gcdn.anvato.net/*",
  "*://*.nmvxdvra2muiv2amejorzkvqgg.gcdn.anvato.net/*",
  "*://*.tfa26fsjgzw475fipe42v4rhcf.gcdn.anvato.net/*",
  "*://*.xheimmxl4gfvfghng2jjos4qhb.gcdn.anvato.net/*",
  "*://*.analytics.any.do/*",
  "*://*.tkmedia.aotter.net/*",
